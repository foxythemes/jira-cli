...
if (!fs.existsSync(configFilePath)) {
  ...
  */
	...
	cl.command('create [options]').description('Create a new issue').action(jira.createIssue);

	/**
  * Remove config file
  */

	cl.command('config [command]').description('Configuration file options').option("-h, --help", "").action(jira.config);
